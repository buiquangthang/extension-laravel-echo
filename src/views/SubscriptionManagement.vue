<template>
  <div>
    ...
    <div class="mt-3 row rounded border"
            v-bind:class="{'bg-success text-light': selectedPlan == 'price_1I6BdULoECQL8nNvrg7Fv0KX'}"
            v-on:click="selectedPlan = 'price_1I6BdULoECQL8nNvrg7Fv0KX'">
        <div class="col-6">
            Basic
        </div>
        <div class="col-6">
...
const axios = Axios.create({
  ...
  headers: {
    Authorization: 'Bearer 13|vseDZLGy5LvMovZfNvNRSfjnT1GRuli7kCaQJPWk'
  }
})
...
export default {
  data () {
    return {
      stripeAPIToken: 'pk_test_51H6vLeLoECQL8nNvI8kRWLBWuMmkEBaMnL5s6xROAyI5HDhde0LS3MwlyodLukFF5vdAcUauKCoZSCRbchh9adGC00ad1HmpqF',
      stripe: '',
      elements: '',
      card: '',
      intentToken: '',
